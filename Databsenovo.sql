...
CREATE TABLE IF NOT EXISTS `mydbb`.`Pokémon` (
  ...
  INDEX `fk_Pokémon_Treinador_idx` (`Treinador_idTreinador` ASC) VISIBLE,
  CONSTRAINT `fk_Pokémon_Treinador`
    FOREIGN KEY (`Treinador_idTreinador`)
    REFERENCES `mydbb`.`Treinador` (`idTreinador`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `mydbb`.`Pokédex` (
  ...
  INDEX `fk_Pokédex_Treinador1_idx` (`Treinador_idTreinador` ASC) VISIBLE,
...
-- -----------------------------------------------------
-- Table `mydbb`.`Pokémon_tem_Habilidades`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydbb`.`Pokémon_tem_Habilidades` (
  ...
  INDEX `fk_Pokémon_has_Habilidades_Habilidades1_idx` (`Atributos_idAtributos` ASC) VISIBLE,
  INDEX `fk_Pokémon_has_Habilidades_Pokémon1_idx` (`Pokémon_idPokémon` ASC, `Pokémon_Treinador_idTreinador` ASC) VISIBLE,
  CONSTRAINT `fk_Pokémon_has_Habilidades_Pokémon1`
    FOREIGN KEY (`Pokémon_idPokémon` , `Pokémon_Treinador_idTreinador`)
    REFERENCES `mydbb`.`Pokémon` (`idPokémon` , `Treinador_idTreinador`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Pokémon_has_Habilidades_Habilidades1`
    FOREIGN KEY (`Atributos_idAtributos`)
    REFERENCES `mydbb`.`Atributos` (`idAtributos`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
